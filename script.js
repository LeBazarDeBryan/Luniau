...
function fetchFileContent(filePath) {
    ...
    document.getElementById('about-btn').addEventListener('click', () => openModal('About Luniau', '2024-present<br /><br />Luniau is a streaming "platform" that streams high-quality audio (1411-1536 Kbit/s). There is no ads, no trackers, no cookies. I try my best for privacy and quality.'));document.getElementById('about-btn').addEventListener('click', () => openModal('About Luniau', '2024-present<br /><br />Luniau is a streaming "platform" that streams high-quality audio (1411-1536 Kbit/s). There is no ads, no trackers, no cookies. I try my best for privacy and quality.<br /><br />Format<br />The date format is DD/MM/YYYY.'));
